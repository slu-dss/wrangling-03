...
Try using `select()` with the `starwars` data frame: 
...
Yout turn! Try using `filter()` with some operators to filter the `starwars` data frame in two or three different ways: 
